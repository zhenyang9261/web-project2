...
if(document.querySelector(".curr-chat")) {
...
function createRecipientInitialsDisplay() {
    console.log("got in create recipient initials display function")
    ...
    console.log(recipientInitialsDisplayContainer);
    return recipientInitialsDisplayContainer;
}

function createRecipientInformationContainer() {
    console.log("got in create recipient information container");
    ...
    console.log(recipientInformationContainer);
